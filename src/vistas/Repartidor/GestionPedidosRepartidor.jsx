...
import '../../estilos/Repartidor/GestionPedidosRepartidor.css'; // Los estilos
...
const GestionPedidosRepartidor = () => {
  ...
  const handleVerPedidosRepartidorClick = () => {
    console.log("Redirigiendo a /VerPedidosRepartidor");  // Ver si el mensaje aparece en la consola
    navigate('/VerPedidosRepartidor');
  };

  const handleDetallesPedidosRepartidorClick = () => {
    console.log("Redirigiendo a /DetallesPedidosRepartidor");  // Ver si el mensaje aparece en la consola
    navigate('/DetallesPedidosRepartidor');
  };
    ...
    <div>
      ...
      <main className="main">
        ...
        <div className="main-buttons">
          <button
            className="button-verpedidosrepartidor"
            onClick={handleVerPedidosRepartidorClick}
          >
            Ver mis Pedidos
          </button>
          <button
            className="button-DetallesPedidosRepartidor"
            onClick={handleDetallesPedidosRepartidorClick}
          >

...
import '../../estilos/Repartidor/InicioRepartidor.css'; // Los estilos
...
const InicioRepartidor = () => {
  ...
  const handleGestionPedidosClick = () => {
    console.log("Redirigiendo a /GestionPedidosRepartidor");  // Ver si el mensaje aparece en la consola
    navigate('/GestionPedidosRepartidor');
  };

  const handleNotificacionesClick = () => {
    console.log("Redirigiendo a /NotificacionesRepartidor");
    navigate('/NotificacionesRepartidor');
  };

  const handleCalificacionEvaluacionClick = () => {
    console.log("Redirigiendo a /CalificacionEvaluacion");
    navigate('/CalificacionEvaluacionRepartidor');
  };

  
  const handleGestionVehiculosClick = () => {
    console.log("Redirigiendo a /GestionVehiculos");
    navigate('/GestionVehiculos');
  };
    ...
    <div>
      ...
      <header className="home-header">
        ...
        <div className="home-header-left">
          <h1>Bienvenido a Sumer Delivery Usuario Repartidor</h1>
        </div>
      ...
      <main className="main">
        ...
        <div className="main-buttons">
          ...
          <button className="button-gestionVehiculos" 
          onClick={handleGestionVehiculosClick}
          >

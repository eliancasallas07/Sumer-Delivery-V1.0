...
import '../../estilos/Repartidor/ChatRestauranteRepartidor.css'; // Los estilos
import '../../Global.css'; // Los estilos

const ChatRestauranteRepartidor = () => {
  const [isConnected, setIsConnected] = useState(false);
  const [message, setMessage] = useState(""); // Agregar estado para el mensaje
...
export default ChatRestauranteRepartidor;
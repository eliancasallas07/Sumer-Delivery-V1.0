...
import '../../estilos/Vendedor/CalificacionEvaluacionVendedor.css'; // Los estilos

const CalificacionEvaluacionVendedor = () => {
  ...
  const pedidos = [
    {
      ...
      hora: "09:15 AM",
      estado: "Entregado",
      detalle: "10 paquetes de galletas",
      total: "$100,000",
      servicioKm: "$8,000",
...
export default CalificacionEvaluacionVendedor;